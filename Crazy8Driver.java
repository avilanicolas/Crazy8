...
public class Crazy8Driver
{
    public static void main(String[] args)
    {
        ...
        ArrayList<ArrayList<Card>> hands = Crazy8Driver.dealCards(deck, 2);
     ...
     */
    private static ArrayList<ArrayList<Card>> dealCards(LStack<Card> deck, int players)
    {
    ...
    private static LStack<Card> makeDeck()
    {
        ...
        for(int i = 1; i <= 14; i++) diamonds.add(new Card(i, "diamond"));
        for(int i = 1; i <= 14; i++) hearts.add(new Card(i, "heart"));
        for(int i = 1; i <= 14; i++) clubs.add(new Card(i, "club"));
        for(int i = 1; i <= 14; i++) spades.add(new Card(i, "spade"));
